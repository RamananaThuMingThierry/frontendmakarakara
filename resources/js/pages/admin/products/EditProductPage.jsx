      ...
      <div className="card border-0 shadow-sm"><div className="card-body">
        ...
        <form onSubmit={onSubmit}>
          ...
          <div className="row g-2">
            <div className="col-12 col-md-6"><div className="mb-3"><label className="form-label">SKU</label><input className={`form-control ${errors.sku ? "is-invalid" : ""}`} value={form.sku} onChange={(event) => setField("sku", event.target.value)} />{firstError("sku") ? <div className="invalid-feedback">{firstError("sku")}</div> : null}</div></div>
